...
const Header = (props) => {
	const { selectedSecondNavBar, barName, logout } = props

	const triggerHtml = (
		<div style={{width: '80px', display: 'flex'}} onClick={logout}>
	...
	return (
		<div className='content-wrapper-header'>
			<p className='content-header-title'>{ selectedSecondNavBar?.name || barName }</p>
			<div>
				<Popover
